...
public class CajeroElectronico{
	...
	public void actualizarTotalCajero(String usuario, String password, int valortotal, int cant_10, int cant_20, int cant_50, int cant_100){
		...
		if (this.user_admin.equals(usuario) && this.clave_admin.equals(password)) {
			...
			this.registrarLog("ABASTECER", "0000000000000000", valortotal, "Error:401");
	...
	public void consultarSaldoTarjeta(TarjetaDebito saldotar, String pass){
		...
		if ( saldotar.verificarPassword(pass) ){
			...
			this.registrarLog("|| CONSULTAR SALDO : ", saldotar.getNumero(), 0, "OK:601");
		}else{
			System.out.println("||-------------------------------------------------------------||");
			System.out.println(" ===== ERROR - PASSWORD INCORRECTO =====");
			this.registrarLog("ERROR CONSULTAR SALDO", saldotar.getNumero(), 0, "Error: 602");
		}
	}
	public void cambiarClave(TarjetaDebito cambiacla,String vieja_pass ,String new_passaword){
		if(cambiacla.verificarPassword(vieja_pass)){
			...
			this.registrarLog(" || CAMBIO CALVE : ", cambiacla.getNumero(), 0, "OK:701");
			System.out.println("||-------------------------------------------------------------||");
		}else{
			System.out.println("||-------------------------------------------------------------||");
			System.out.println("|| ERROR: 607 ");
			this.registrarLog(" ||ERROR CAMBIO CALVE : ", cambiacla.getNumero(), 0, "OK:705");
		}
	}
	public void consignarDineroTarjeta(TarjetaDebito consDinero,  int cant_10, int cant_20, int cant_50, int cant_100){
		...
		System.out.println("||-------------------------------------------------||");
		System.out.println("||MAS "+ sumavalor);
		System.out.println("||-------------------------------------------------||");
