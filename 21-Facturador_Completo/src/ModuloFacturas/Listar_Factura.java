...
import Clases.Factura_Productos;
...
public class Listar_Factura extends javax.swing.JFrame {
    
    private Menu ventanaMenu;
    private JLabel etqTemporal;
    private JButton btnDetalles [];
    private Object listar_Factura;
   
    
    public Listar_Factura(Menu ventanaMenu) {
    ...
    public void imprimirFacturas(){
        ...
        Factura listaFacturas [] = ( this.ventanaMenu.database.listar_Factura()); 
        btnDetalles = new JButton [listaFacturas.length];
       
        
        if (listar_Factura!=null) {
            for(int i = 0; listar_Factura.length >= i; i++) {
                ...
                if(factura != null) {
                    ...
                    ActionListener evento_01 = new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            Factura_Producto arreglo_productos [] = instancia.buscarProducto_Factura(String.valueOf(factura.getId()));
                            Lista_Detalles ventana = new Lista_Detalles(factura.getId(), factura.getCedula_cliente(), factura.getCedula_vendedor(), factura.getTotal(), arreglo_productos);
