...
public class Lista_Detalles extends javax.swing.JFrame {
    int id_factura;
    int cedulaCliente;
    int cedulaVendedor;
    int total;
    JLabel etqTemporal;
    Factura_Productos arreglo_productos [];
    

    public Lista_Detalles(int id_factura, int cedulaCliente, int cedulaVendedor, int total, Factura_Productos[] arreglo_productos) {
    ...
    public void imprimirDetalles(){
       ...
       campoCedulaCliente.setText(String.valueOf(this.cedulaCliente));
       campoCedulaVendedor.setText(String.valueOf(this.cedulaVendedor));
